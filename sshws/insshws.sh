...
wget -O /usr/local/bin/ws "https://raw.githubusercontent.com/freetunnel/lot/main/sshws/ws"
chmod +x /usr/local/bin/ws

# Installing Service
cat > /etc/systemd/system/ws.service << END
[Unit]
Description=Proxy Mod By FREETUNNEL CORP
...
wget -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/freetunnel/lot/main/sshws/ws"
