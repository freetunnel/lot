...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/freetunnel/lot/main/install/haproxy.cfg"
...
echo 'Please send in your comments and/or suggestions to https://t.me/freetunnel3'
